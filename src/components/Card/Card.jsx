...
const Card = ({ product, isSmall = false, customButton }) => {
  const {
    name,
    price,
    originalPrice,
  ...
  let classNameProduct = "product-card";
  let classNameImageContainer = "product-image-container";
  if (isSmall) {
    classNameProduct = "product-card-small";
    classNameImageContainer = "product-image-container-small";
  }
  return (
    <div className={classNameProduct}>
      <div className={classNameImageContainer}>
